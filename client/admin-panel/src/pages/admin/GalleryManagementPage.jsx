...
export default function GalleryManagementPage() {
  ...
  return <div>
    ...
    {open && <form className="event-form" onSubmit={submit}><h2>{editing ? 'Edit Gallery Media' : 'Add Gallery Media'}</h2><div className="form-grid">
      ...
      <label className="full-width">Description (optional)<textarea rows="3" value={form.caption} onChange={(event) => setForm({ ...form, caption: event.target.value })} placeholder="Short description shown under the image on the gallery" /></label>
