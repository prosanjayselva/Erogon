              ...
              <div className="form-card mt-32">
                {submitted ? (
                  <div className="center" style={{ padding: "20px 0" }}>
                    ...
                    <p style={{ color: "var(--ink-500)", marginTop: 8 }}>Thank you — we've received your interest and will reach out soon.</p>
                    <button className="btn btn--ghost btn--sm mt-16" onClick={() => setSubmitted(false)}>Submit Another Response</button>
                  </div>
                ) : (
              ...
              <div className="form-card">
                {submitted ? (
                  <div className="center" style={{ padding: "20px 0" }}>
                    <div className="icon-badge mx-auto" style={{ background: "var(--gold-600)", color: "var(--forest-950)" }}><CheckIcon /></div>
                    <h3 className="h-sm">Thank You</h3>
                    <p style={{ color: "var(--ink-500)", marginTop: 8 }}>Thank you — your form has been submitted. ERGON's placement team will be in touch.</p>
                    <button className="btn btn--ghost btn--sm mt-16" onClick={() => setSubmitted(false)}>Submit Another Response</button>
                  </div>
                ) : role === "seeker" ? (
