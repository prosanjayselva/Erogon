...
const menu = [
  ...
  { id: 'donors', label: 'Donor Management', icon: '👥', path: '/admin/donors' },
  { id: 'events', label: 'Event Management', icon: '📅', path: '/admin/events' },
  { id: 'audit', label: 'Audit Logs', icon: '📋', path: '/admin/audit-logs' },
  { id: 'settings', label: 'Settings', icon: '⚙️', path: '/admin/settings' },
  { id: 'website', label: 'View Website', icon: '🌐', path: '/' },
];
    ...
    <div className="admin-shell">
      ...
      <aside className="admin-sidebar">
        <div className="sidebar-logo">
          <img src="/assets/logo.svg" alt="ERGON" className="sidebar-logo-img" />
