...
/**
 * The Root Line — ERGON's signature connective device.
 * A single vine draws itself left to right and branches into three
 * leaves, echoing "People · Pets · Planet" growing from one root.
 * Reused as a section divider and (in compact form) as a timeline spine.
 */
export default function RootLine({ compact = false, labels = true }) {
  ...
  return (
    <div className="root-line-wrap" ref={ref}>
      ...
      {labels && !compact && (
        <div className="flex-between" style={{ maxWidth: 640, margin: "0 auto", fontSize: "0.72rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--text-secondary)", fontWeight: 700, padding: "0 8%" }}>
          <span>People</span>
          <span>Pets</span>
          <span>Planet</span>
        </div>
