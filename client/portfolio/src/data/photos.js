...
export const GALLERY_PHOTOS = [
  { src: PHOTOS.aiHeroGirlDog, caption: "People and pets - compassion in action", ratio: "4/3" },
  { src: PHOTOS.aiPetHero, caption: "Pet welfare and animal care", ratio: "4/3" },
  ...
  { src: PHOTOS.ramanathapuramThumbprint, caption: "Plants protection pledge", ratio: "4/3" },
  ...
  { src: PHOTOS.yercaudPledge, caption: "Plants and planet pledge", ratio: "4/3" },
  ...
  { src: PHOTOS.reportEnvironment, caption: "Plants impact report", ratio: "16/9" },
...
export const GALLERY_WITH_CATEGORIES = [
  ...
  { ...GALLERY_PHOTOS[3], category: "plants" },
  { ...GALLERY_PHOTOS[4], category: "plants" },
  { ...GALLERY_PHOTOS[5], category: "plants" },
  { ...GALLERY_PHOTOS[6], category: "plants" },
  { ...GALLERY_PHOTOS[7], category: "plants" },
  { ...GALLERY_PHOTOS[8], category: "people" },
  { ...GALLERY_PHOTOS[9], category: "plants" },
  ...
  { ...GALLERY_PHOTOS[18], category: "plants" },
